...
export function LowStockTable() {
  ...
  const lowStockItems = apiData?.lowStockItems || [];
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs text-[#555555]">
          ...
          <tbody className="divide-y divide-black/4">
            {isLoading ? (
              <tr>
                <td colSpan={6} className="py-6 text-center text-[#999999]">
                  Loading inventory status...
                </td>
              </tr>
            ) : lowStockItems.length === 0 ? (
              <tr>
                <td colSpan={6} className="py-8 text-center text-[#999999]">
                  No low stock alerts. All inventory levels healthy.
                </td>
              </tr>
            ) : (
